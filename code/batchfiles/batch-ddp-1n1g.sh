...
#SBATCH --mem 16384
#SBATCH --job-name gpt2-ddp-1n1g
#SBATCH --output gpt2-ddp-1n1g-%j.out

# Execute using:
# sbatch batch-ddp-1n1g.sh
...
python -m torch.distributed.launch --standalone --nproc_per_node=1 train_gpt2_ddp.py
