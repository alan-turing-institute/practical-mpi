...
\author{Baskerville Training\\25-26 November 2025 -- David Llewellyn-Jones}
...
\item Configure the session:
  \begin{enumerate}
  \item Kernel to load: {\tt Python 3.11.3 (2023a / GCCcore-12.3.0)}
  \item Show Conda Environment: Unselected
  \item Number of hours: 2
  \item Number of GPUs: 1
  \item Baskerville project {\tt vjgo8416-hpc2511}
  \item Queue: {\tt turing}
  \nd{enumerate}
\item Launch
\end{enumerate}
